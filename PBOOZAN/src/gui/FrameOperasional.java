...
public class FrameOperasional extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("biayaMobil");

        jLabel4.setText("biayaSupir");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameOperasional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameOperasional().setVisible(true);
            }
        });
    }
